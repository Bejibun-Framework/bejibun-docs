...
Bejibun provides a storage abstraction layer that supports multiple storage drivers, via the standalone
[`@bejibun/storage`](/v0.6/guides/storage/file-storage) package (as of v0.6.0).
