...
The storage system provides a unified interface for managing files. As of v0.6.0, it ships as the standalone
[`@bejibun/storage`](/v0.6/guides/storage/file-storage) package rather than being built into `@bejibun/core`.
